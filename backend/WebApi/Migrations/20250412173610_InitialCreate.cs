        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OpeningHoursId = table.Column<long>(type: "bigint", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MedicalCenters_Locations_LocationId",
                        column: x => x.LocationId,
                        principalTable: "Locations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MedicalCenters_OpeningHours_OpeningHoursId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Procedures_MedicalCenters_MedicalCenterId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Traffic_MedicalCenters_MedicalCenterId",
                        column: x => x.MedicalCenterId,
                        principalTable: "MedicalCenters",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MedicalCenters_LocationId",
                table: "MedicalCenters",
                column: "LocationId");

            migrationBuilder.CreateIndex(
                name: "IX_MedicalCenters_OpeningHoursId",
                table: "MedicalCenters",
                column: "OpeningHoursId");

            migrationBuilder.CreateIndex(
                name: "IX_Procedures_MedicalCenterId",
                table: "Procedures",
                column: "MedicalCenterId");

            migrationBuilder.CreateIndex(
                name: "IX_Traffic_MedicalCenterId",
                table: "Traffic",
                column: "MedicalCenterId");
        }
